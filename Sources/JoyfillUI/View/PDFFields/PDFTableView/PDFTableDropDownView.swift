...
struct PDFTableDropDownOptionListView: View {
    ...
    var body: some View {
        VStack(alignment: .leading) {
            ...
            .sheet(isPresented: $isSheetPresented) {
                PDFTableDropDownOptionList(data: cellModel.data, selectedDropdownValue: $selectedDropdownValue)
            }
        }
...
struct PDFTableDropDownOptionList: View {
