...
struct PDFSignatureView: View {
    @State private var lines: [PDFLine] = []
    ...
    var body: some View {
        VStack(alignment: .leading) {
            ...
            NavigationLink(destination: PDFCanvasSignatureView(lines: $lines, signatureImage: $signatureImage), isActive: $showCanvasSignatureView) {
                EmptyView()
            }
...
struct PDFCanvasView: View {
    @State var currentLine = PDFLine()
    @Binding var lines: [PDFLine]
        ...
        ZStack {
            ...
            .gesture(DragGesture(minimumDistance: 0,coordinateSpace: .local)
                .onChanged({value in
                    ...
                    .onEnded({value in
                        self.currentLine = PDFLine(points: [])
                    }))
        }
    }
...
struct PDFCanvasSignatureView: View {
        ...
        VStack(alignment: .leading) {
            ...
            HStack {
                ...
                Button(action: {
                    ...
                    signatureImage = PDFCanvasView(lines: $lines)
