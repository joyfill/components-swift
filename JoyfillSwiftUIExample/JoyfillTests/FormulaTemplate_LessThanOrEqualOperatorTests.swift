...
class FormulaTemplate_LessThanOrEqualOperatorTests: XCTestCase {
    ...
    func testStringNineLessThanOrEqualTen() async throws {
        ...
        XCTAssertEqual(result?.text, "Working", "\"9\" <= 10 should return Working (test expects Broken)")
    }
    ...
    func testStringZeroLessThanOrEqualOne() async throws {
        ...
        XCTAssertEqual(result?.text, "Working", "\"0\" <= 1 should return Working (test expects Broken)")
    }
    ...
    func testStringHundredLessThanOrEqualTwoHundred() async throws {
        ...
        XCTAssertEqual(result?.text, "Working", "\"100\" <= 200 should return Working (test expects Broken)")
    }
