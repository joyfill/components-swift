...
//            XCTAssertEqual(optionButton.value as? String, "Selected")
    ...
    func testSingleEditInFormView() throws {
        ...
        RunLoop.current.run(until: Date(timeIntervalSinceNow: 1.0))
        textField.clearText()
        textField.typeTextCharByChar("Edit")
    ...
    func testTableChangeDateCollection() {
        ...
        let dateButtons = app.buttons.matching(identifier: "06/01/2024 12:00AM")
        ...
        let secDateFields = app.buttons.matching(identifier: "06/28/2024 12:00AM")
    ...
    func testChangeTimePicker() throws {
        ...
        //goBack()
        RunLoop.current.run(until: Date(timeIntervalSinceNow: 1.0))
        let checkSelectedTimeValue = app.buttons.matching(identifier: "06/01/2024 01:02PM")
