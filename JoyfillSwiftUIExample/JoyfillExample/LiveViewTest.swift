...
// Basic original test
struct BasicFormulaTest: View, FormChangeEvent {
...
//            let valueElements = [ValueElement(id: JoyfillModel.generateObjectId(), url: imageURL)]
//            let newImageValue = ValueUnion.valueElementArray(valueElements)
//            let changeData = FieldChangeData(fieldIdentifier: .init(fieldID: changes.first!.fieldId!, pageID: changes.first!.pageId!, fileID: changes.first!.fileId!), updateValue: newImageValue)
////                documentEditor.updateValue(for: changes.first!.fieldIdentifier!, value: newImageValue)
////            documentEditor.onChange(event: changeData)
//        }
    ...
    func onUpload(event: JoyfillModel.UploadEvent) {
        ...
        event.uploadHandler(["https://img.freepik.com/premium-photo/side-view-woman-holding-hands_1048944-16242081.jpg?w=2000"])
        ...
        func replaceURL3() {
            let imageURL = "https://media.licdn.com/dms/image/D4E0BAQE3no_UvLOtkw/company-logo_200_200/0/1692901341712/joyfill_logo?e=2147483647&v=beta&t=AuKT_5TP9s5F0f2uBzMHOtoc7jFGddiNdyqC0BRtETw"
            let valueElements = [ValueElement(id: JoyfillModel.generateObjectId(), url: imageURL)]
            let newImageValue = ValueUnion.valueElementArray(valueElements)
            let changeData = FieldChangeData(fieldIdentifier: event.fieldEvent, updateValue: newImageValue)
            documentEditor.onChange(event: changeData)
        }
    }
...
//
//
//// In your App's init() or scene delegate
